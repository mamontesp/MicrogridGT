...
import  modules.loading_data.loading_data as loading_data
import modules.utility_functions.utility_functions as uf
...
def loadData():
	...
	td_ff, pv_ff, wt_ff, ld_ff, bt_ff, de_ff, teg_ff= loading_data.openFile(dataset, playwithgrid)
...
def graphInitialData():
	...
	if( playwithgrid == True):
		...
		ax2.set_xlabel(r'Hours in a day')
		ax2.set_ylabel(r'Tariff per kWh [\$]')
	else:
	...
	ax1.set_xlabel(r'Hours in a day')
	ax1.set_ylabel(r'kWh')
...
def graphFinalData():
	...
	ax1.set_title(r'Resources dispatch')
	ax2.set_title(r'Battery state')
	ax3.set_title(r'Power balance value')

	ax1.set_xlabel(r'Hours in a day')
	ax1.set_ylabel(r'kWh')

	ax2.set_xlabel(r'Hours in a day')
	ax2.set_ylabel(r'% of charge')

	ax3.set_xlabel(r'Hours in a day')
	ax3.set_ylabel(r'kWh')
